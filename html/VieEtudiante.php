...
<body>
    ...
    <div class="Les_campus">
        ...
        <div id="text_campus">
            ...
            • Installés au coeur de grandes villes dynamiques, les campus de ISART Digital offrent un environnement moderne
            et
            ...
            • Salles informatiques équipées, espaces de travail collaboratif, zones de prototypage et de production : tout
            est conçu
